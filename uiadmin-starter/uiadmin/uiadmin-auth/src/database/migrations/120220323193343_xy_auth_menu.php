...
class XyAuthMenu extends Migrator
{
    ...
    {
        $table = $this->table('xy_auth_menu', ['engine' => 'InnoDB', 'collation' => 'utf8_general_ci', 'comment' => '' ,'id' => false ,'primary_key' => ['id']]);
        $table->addColumn('id', 'string', ['limit' => 32,'null' => false,'default' => '','signed' => true,'comment' => 'ID',])
			...
			->addColumn('menu_layer', 'string', ['limit' => 1,'null' => false,'default' => '','signed' => true,'comment' => '分层标记',])
