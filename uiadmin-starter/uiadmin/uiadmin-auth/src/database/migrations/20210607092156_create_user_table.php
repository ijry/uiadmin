...
class CreateUserTable extends Migrator
{
    ...
    {
        $table  =  $this->table('auth_user',array('engine'=>'InnoDB'));
        ...
        ->addColumn('lastLoginIp', 'integer',array('limit'  =>  11,'default'=>0,'comment'=>'最后登录IP'))
        ->addColumn('lastLoginTime', 'datetime',array('default'=>0,'comment'=>'最后登录时间'))
