            ...
            try {
                ...
                $buildData = [
                    '__file__'   => [
                        ...
                        $moduleNameWithSubdir . '/src/ConfigProvider.php'
                    ],
                    '__dir__'    => [
                        $moduleNameWithSubdir . '/src/controller',
                        $moduleNameWithSubdir . '/src/admin',
                        $moduleNameWithSubdir . '/src/console',
                        $moduleNameWithSubdir . '/src/listener',
                        $moduleNameWithSubdir . '/src/model',
                        $moduleNameWithSubdir . '/src/service',
                        $moduleNameWithSubdir . '/src/util',
...
EOF;
                file_put_contents(base_path() . 'extention/' . $moduleNameWithSubdir . '/src/ConfigProvider.php', $serviceContent);
...
EOF;
                file_put_contents(base_path() . 'extention/' . $moduleNameWithSubdir . '/src/listener/EventListener.php', $eventListenerContent);
