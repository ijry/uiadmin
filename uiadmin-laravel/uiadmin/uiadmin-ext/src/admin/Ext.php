...
class Ext extends BaseAdmin
{
    ...
    public function lists()
    {
        ...
        if ($type == 'local' || $type == '') {
            ...
            $res = file_get_contents('https://uiadmin.jiangruyi.com/api/v1/ext/addon/lists?framework=laravel', false, stream_context_create($stream_opts));
            ...
            try {
                ...
                $buildData = [
                    ...
                    '__dir__'    => [
                        ...
                        $moduleNameWithSubdir . '/src/command',
