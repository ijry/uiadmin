...
VALUES
  ...
  ('core', '', '/core/system/cleanRuntime', '/system', '清空缓存', '清空服务器端缓存', 3, '0', 'v1', '', '', 'DELETE', NULL, 0, 0, 0),
  ...
  ('core', '', '/core/system/checkUpdate', '/system', '检查更新', '检查InitAdmin新版本', 3, '0', 'v1', '', '', 'GET', NULL, 0, 0, 0),
