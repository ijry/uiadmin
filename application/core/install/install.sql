...
INSERT INTO `ia_core_menu` (`id`, `module`, `path`, `pmenu`, `title`, `tip`, `menu_type`, `route_type`, `api_prefix`, `api_suffix`, `api_params`, `api_method`, `doc`, `is_hide`, `sortnum`, `delete_time`)
VALUES
	(1, 'core', '/developer', '', '开发者', '一般是开发者采用得到的工具', 0, '0', '', '', '', '', NULL, 0, 99, 0),
	...
	(9, 'core', '/system', '', '系统', '核心系统相关功能', 0, '0', '', '', '', '', NULL, 0, 1, 0),
	...
	(21, 'core', '/core/system/checkUpdate', '/system', '检查更新', '检查InitAdmin新版本', 3, '0', 'v1', '', '', 'DELETE', NULL, 0, 0, 0),
	...
	(29, 'core', '/core/user/login', '', '用户登录', '用户登录', 5, '', 'v1', '', '', 'POST', '{\"POST\":{\"description\":\"sad\",\"params\":[{\"description\":\"a\",\"require\":\"aa\",\"name\":\"a\",\"title\":\"a\",\"example\":\"a\"}]}}', 0, 0, 0),
	...
	(35, 'core', '/core/user/logout', '', '注销登录', '', 5, 'route', 'v1', '', '', 'DELETE', NULL, 0, 0, 0),
