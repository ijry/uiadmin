...
VALUES
  (1, 'core', 'md-code', '/developer', '', '开发', '一般是开发者采用得到的工具', 0, '', '', '', '', '', NULL, 0, 99, 0),
  (2, 'core', '', '/core/menu/lists', '/developer', '菜单列表', '管理后台左侧的菜单导航', 3, 'list', 'v1', '', '', 'GET', NULL, 0, 0, 0),
  (3, 'core', '', '/core/role/trees', '/core', '权限管理', '管理系统角色及权限', 1, 'list', 'v1', '', '', 'GET', NULL, 0, 2, 0),
  (4, 'core', '', '/core/user/lists', '/core', '用户列表', '系统注册用户列表', 1, 'list', 'v1', '', '', 'GET', NULL, 0, 3, 0),
  (5, 'core', '', '/core/user/edit', '/core/user/lists', '修改用户', '修改用户信息', 2, 'form', 'v1', '/:id', '', 'GET|PUT', NULL, 0, 0, 0),
  (6, 'core', '', '/core/user/delete', '/core/user/lists', '删除用户', '软删除用户', 2, '', 'v1', '/:id', '', 'DELETE', NULL, 0, 0, 0),
  ...
  (9, 'core', 'md-cog', '/core', '', '系统', '核心系统相关功能', 0, '', '', '', '', '', NULL, 0, 1, 0),
  ...
  (12, 'core', '', '/core/role/delete', '/core/role/trees', '删除角色', '删除角色', 2, '', 'v1', '/:id', '', 'DELETE', NULL, 0, 0, 0),
  ...
  (16, 'core', '', '/core/user_role/delete', '/core/user_role/lists', '删除角色成员', '删除一个角色成员', 2, '', 'v1', '/:uid/:name', '', 'DELETE', NULL, 0, 0, 0),
  (17, 'core', '', '/core/index/cleanRuntime', '/core', '清空缓存', '清空服务器端缓存', 3, '', 'v1', '', '', 'DELETE', NULL, 0, 0, 0),
  ...
  (20, 'core', '', '/core/menu/delete', '/core/menu/trees', '删除菜单', '删除后台菜单(接口)', 2, '', 'v1', '/:id', '', 'DELETE', NULL, 0, 0, 0),
  (21, 'core', '', '/core/index/checkUpdate', '/core', '检查更新', '检查InitAdmin新版本', 3, '', 'v1', '', '', 'GET', NULL, 0, 0, 0),
  ...
  (28, 'core', '', '/core/config/saveBatch', '/core', '系统设置', '批量修改系统配置的值', 1, 'form', 'v1', '/:module', '/core', 'GET|PUT', NULL, 0, 1, 0),
  (29, 'core', '', '/core/user/login', '', '用户登录', '用户登录', 5, '', 'v1', '', '', 'GET|POST', '{\"POST\":{\"description\":\"使用凭证登录系统\",\"params\":[{\"description\":\"支持多种身份验证方式\",\"require\":\"0\",\"name\":\"identity_type\",\"title\":\"验证方式\",\"example\":\"0\"},{\"require\":\"1\",\"name\":\"identifier\",\"title\":\"账号\",\"description\":\"用户名，邮箱，手机号\",\"example\":\"admin@qq.com\"},{\"name\":\"credential\",\"require\":\"1\",\"title\":\"凭证\",\"description\":\"密码\",\"example\":\"qwe123\"}],\"divider\":\"\"}}', 0, 0, 0),
  (30, 'core', '', '/core/api/add', '/core/api/trees', '添加前台API', '添加前台API接口', 2, 'form', 'v1', '', '', 'GET|POST', NULL, 0, 0, 0),
  (31, 'core', '', '/core/api/delete', '/core/api/trees', '删除前台API', '删除后前台API接口', 2, '', 'v1', '/:id', '', 'DELETE', NULL, 0, 0, 0),
  ...
  (52, 'core', '', '/core/user/login', '', '后台登录', '后台登录', 3, '', 'v1', '', '', 'GET|POST', '{\"POST\":{\"description\":\"使用凭证登录系统\",\"params\":[{\"description\":\"支持多种身份验证方式\",\"require\":\"0\",\"name\":\"identity_type\",\"title\":\"验证方式\",\"example\":\"0\"},{\"require\":\"1\",\"name\":\"identifier\",\"title\":\"账号\",\"description\":\"用户名，邮箱，手机号\",\"example\":\"admin@qq.com\"},{\"name\":\"credential\",\"require\":\"1\",\"title\":\"凭证\",\"description\":\"密码\",\"example\":\"qwe123\"}],\"divider\":\"\"}}', 0, 0, 0),
  (53, 'core', '', '/core/install/step1', '', '安装步骤1', '', 5, '', 'v1', '', '', 'GET|POST', '', 0, 0, 0),
  (54, 'core', '', '/core/install/step2', '', '安装步骤2', '', 5, '', 'v1', '', '', 'GET|POST', '', 0, 0, 0),
  (55, 'core', '', '/core/install/step3', '', '安装步骤3', '', 5, '', 'v1', '', '', 'GET|POST', '', 0, 0, 0),
  (56, 'core', '', '/core/install/step4', '', '安装步骤4', '', 5, '', 'v1', '', '', 'GET|POST', '', 0, 0, 0),
  (57, 'core', '', '/core/install/step5', '', '安装步骤5', '', 5, '', 'v1', '', '', 'GET|POST', '', 0, 0, 0),
  (58, 'core', '', '/core/index/config', '/core', '核心配置', '获取核心模块配置', 5, '', 'v1', '', '', 'GET', NULL, 0, 0, 0),
  (59, 'core', '', '/core/index/index', '', '后台首页', '', 3, 'route', 'v1', '', '', 'GET', NULL, 0, 0, 0),
  (60, 'core', '', '/core/index/setStatus', '/core', '设置状态', '设置状态', 3, '', 'v1', '', '', 'PUT', NULL, 0, 0, 0);
