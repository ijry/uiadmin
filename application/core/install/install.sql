...
INSERT INTO `ia_core_menu` (`id`, `module`, `path`, `pmenu`, `title`, `tip`, `menu_type`, `route_type`, `api_prefix`, `api_suffix`, `api_params`, `api_method`, `is_hide`, `sortnum`, `delete_time`)
VALUES
  ...
  (8, 'core', '/core/config/lists', '/developer', '设置管理', '系统常用设置', 1, 'list', 'v1', '', '', 'GET', 0, 4, 0),
  ...
  (28, 'core', '/core/config/saveBatch', '/system', '系统设置', '批量修改系统配置的值', 1, 'form', 'v1', '/:module', '/core', 'GET|PUT', 0, 1, 0),
  (29, 'core', '/core/user/login', '', '用户登录', '用户登录', 5, '', 'v1', '', '', 'POST', 0, 0, 0),
  (30, 'core', '/core/api/add', '/core/api/trees', '添加前台API', '添加前台API接口', 2, 'form', 'v1', '', '', 'GET|POST', 0, 0, 0),
  (31, 'core', '/core/api/delete', '/core/api/trees', '删除前台API', '删除后前台API接口', 2, '0', 'v1', '/:id', '', 'DELETE', 0, 0, 0),
  (32, 'core', '/core/api/edit', '/core/api/trees', '修改前台API', '修改前台API接口', 2, 'form', 'v1', '/:id', '', 'GET|PUT', 0, 0, 0),
  (33, 'core', '/core/api/trees', '/developer', 'API管理', '管理前台API', 1, 'list', 'v1', '', '', 'GET', 0, 3, 0),
  (34, 'core', '/core/user/register', '', '用户注册', '', 5, 'route', 'v1', '', '', 'POST', 0, 0, 0),
  (35, 'core', '/core/user/logout', '', '注销登录', '', 5, 'route', 'v1', '', '', 'DELETE', 0, 0, 0),
  (36, 'core', '/core/user/isLogin', '', '检查登录状态', '检查用户是否真的登录', 5, 'route', 'v1', '', '', 'GET', 0, 0, 0),
  (37, 'core', '/core/user/info', '', '获取用户信息', '获取登录的用户信息', 5, 'route', 'v1', '', '', 'GET', 0, 0, 0);
...
CREATE TABLE `ia_core_config` (
  ...
  `config_cate` int(4) NOT NULL DEFAULT '0' COMMENT '配置分组',
